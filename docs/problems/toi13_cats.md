...
title: toi13_cats
---
# คำอธิบายวิธีทำพร้อม code สำหรับข้อ [toi13_cats](https://api.otog.in.th/problem/471)
...
สำหรับการคำนวนหาค่า $f(x)$ เราสามารถใช้การ Brute Force ได้โดยที่เราไม่ต้องสนใจแมวที่มีขนาดน้อยกว่าหรือเท่ากับ $x$ เลยเพราะเราสามารถเคลื่อนย้ายมันได้ เราแค่ต้องเช็คว่าคู่แมวที่มีขนาดมากกว่า $x$ อยู่ติดกันหรือไม่
