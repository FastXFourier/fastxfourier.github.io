...
ซึ่งโดยหลักการ Prefix Sum เมื่อเรา $query$ ตำแหน่งใดๆแล้ว หากความสูงดังกล่าวมันสูงกว่าตำแหน่งที่เกิดการ $update -o$ ไปแล้ว จะทำให้หักล้างกับตำแหน่งที่เรา $update +o$ ไป การ $query(idx)$ จึงได้ค่าสีในช่องดังกล่าวนั่นเอ
