...
2. ไล่จากเลข 2 ขึ้นไป ถ้าเลขไหน**ยังไม่ถูกตัดทิ้ง** **แปลว่ามันเป็นจำนวนเฉพาะ** 

    2.1. **"ขีดฆ่า"** พหุคูณของมันทั้งหมด (ไม่ขีดฆ่าตัวเอง เช่น 2 ก็ลบ 4,6,8,... → 3 ก็ลบ 6,9,12,...) เพราะตัวเลขเหล่านั้นมีตัวประกอบแน่นอน
    
    2.2. วนลูปเรื่อยๆจนถึง $\sqrt N$ ก็พอ เพราะถ้าเลขไหนมีตัวประกอบ มันต้องมีตัวหนึ่งที่ $\leq \sqrt N$ สุดท้ายเลขที่ไม่ถูกขีดฆ่าจะเหลือแต่จำนวนเฉพาะนั่นเอง
...
- ด้านขวา เราจะต้อง **$push\_back()$**
- ด้านซ้าย เราจะต้อง **$pop\_front()$**

ซึ่งเป็นสิ่งที่มี Data Structure หนึ่งที่ทำได้ ซึ่งคือ [**Deque**](https://www.geeksforgeeks.org/dsa/deque-set-1-introduction-applications/) นั่นเอง

#### **→ 2.1. หลักการทำงานของ "Sliding Window"**

คิดง่ายๆว่า **Deque** ทำหน้าที่**เก็บ**สมาชิกของ **Window** ปัจจุบันทั้งหมด โดยขั้นตอนจะเป็น:

1. loop ตามทุกๆข้อมูล ตั้งแต่ $1$ ถึง $N$

    1.1. **เพิ่มค่า**: เราอ่านข้อมูลตัวใหม่ → **$push\_back()$** เข้าไป แล้วอัปเดตค่าที่เราเก็บ (เช่น sum, mx, etc.)
    
    1.2. **ตัดทิ้ง**: ถ้า **Window** **"ตรงเงื่อนไขแล้ว"** → **$pop\_front()$** จนกว่าจะไม่ตรงเงื่อนไข 

    1.3. **อัปเดต**: ระหว่างการ **pop** เราก็คอย**อัปเดตคำตอบ**

สังเกตว่า ข้อมูลทุกตัว จะ **เข้า Deque ครั้งเดียว** และ **ออกจาก Deque ครั้งเดียว**
ดังนั้น จะได้ว่า:
#### Time Complexity : $O(N)$

#### **→ 2.2. ลักษณะโจทย์ที่ใช้ Sliding Window**
